  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-6 px-4 space-y-10 animate-in fade-in duration-300">
      ...
      <div className="space-y-2 border-b border-[#dac2b8]/10 pb-5">
        <h2 className="font-serif text-3xl font-light text-on-surface">DocumentaÃ§Ã£o & Ãndice de Fragmentos</h2>
        <p className="text-sm text-on-surface-variant leading-relaxed">
          Navegue pelos fragmentos de mundo comunitÃ¡rios. Gerencie seus fragmentos registrados e explore o acervo por territÃ³rio, origem e formato.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="glass-panel border border-[#dac2b8]/15 rounded-xl p-5 flex items-center gap-4">
          ...
          <div>
            <span className="font-mono text-[10px] uppercase text-on-surface-variant/60 block font-semibold">Fragmentos PrÃ³prios</span>
        ...
        <div className="glass-panel border border-[#dac2b8]/15 rounded-xl p-5 flex items-center gap-4">
          ...
          <div>
            ...
            <span className="font-serif text-2xl text-on-surface tracking-wide">{totalTerritories} Ãreas</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in fade-in duration-300">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-serif text-xl text-on-surface">DivisÃ£o por Ãrea Ativa</h3>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-serif text-xl text-on-surface">CatÃ¡logo de Fragmentos de {currentTerritory}</h3>
            </div>
              ...
              {filteredFragments.length > 0 ? (
                ...
                <div className="border border-dashed border-[#dac2b8]/10 rounded-2xl p-8 text-center space-y-3">
                  ...
                  <p className="text-xs text-on-surface-variant/70 leading-relaxed max-w-xs mx-auto font-sans">
                    Nenhum fragmento de mundo foi inserido nesta Ã¡rea ainda. Proponha um novo fragmento clicando no botÃ£o "+" flutuante.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-on-surface-variant max-w-xl font-sans mt-0.5">
                Overview de todos os fragmentos de mundo propostos e publicados por vocÃª na comunidade.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {userRegisteredFragments.length > 0 ? (
              ...
              <div className="md:col-span-2 border border-dashed border-[#dac2b8]/15 rounded-2xl p-12 text-center space-y-4">
                ...
                <p className="font-serif text-lg text-on-surface">Seu acervo de fragmentos estÃ¡ vazio</p>
                <p className="text-xs text-on-surface-variant/70 leading-relaxed max-w-sm mx-auto font-sans">
                  VocÃª ainda nÃ£o cadastrou nenhum fragmento de mundo na constelaÃ§Ã£o. Clique no botÃ£o de mais "+" flutuante abaixo para registrar seu primeiro fragmento!
                </p>
              </div>
            )}
          </div>
        ...
        <div className="space-y-6 animate-in fade-in duration-300">
          <div>
            <h3 className="font-serif text-2xl text-on-surface flex items-center gap-2">
              ...
              Acervo Salvo de Outros TerritÃ³rios
            </h3>
            <p className="text-xs text-on-surface-variant max-w-xl font-sans mt-0.5">
              Suas referÃªncias salvas de outros setores e subdivisÃµes da comunidade para consulta e escuta posterior.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {savedFragments.length > 0 ? (
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-[9px] uppercase tracking-wider text-on-surface-variant/60 font-semibold select-none">
                          {f.type === 'audio' ? 'Fragmento Sonoro' : f.type === 'visual' ? 'Fragmento Visual' : 'Fragmento Textual'} â€¢ {f.territory}
                        </span>
                      </div>
              ...
              <div className="md:col-span-2 border border-dashed border-[#dac2b8]/15 rounded-2xl p-12 text-center space-y-4">
                ...
                <p className="text-xs text-on-surface-variant/70 leading-relaxed max-w-sm mx-auto font-sans">
                  Quando estiver navegando pela ConstelaÃ§Ã£o, abra o card de qualquer fragmento de mundo e salve-o para colecionÃ¡-los aqui neste acervo.
                </p>
              </div>
            )}
          </div>
